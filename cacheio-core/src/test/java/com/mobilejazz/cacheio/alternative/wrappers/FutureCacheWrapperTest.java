...
public class FutureCacheWrapperTest {
    ...
    @Mock
    private RxCache<String, String> delegate;

    private FutureCacheWrapper<String, String> wrapper;

    @Before
    public void beforeTest(){
        wrapper = FutureCacheWrapper.newBuilder(String.class, String.class)
    ...
    public void testNullDelegate(){
        FutureCacheWrapper.newBuilder(String.class, String.class)
                .build();
    }
    ...
    public void testGetAll() throws ExecutionException, InterruptedException {
        ...
        final Single<Map<String, String>> single = Single.create(new Single.OnSubscribe<Map<String, String>>() {
            @Override
    ...
    public void testRemoveAll() throws ExecutionException, InterruptedException {
        ...
        final Single<Collection<String>> single = Single.create(new Single.OnSubscribe<Collection<String>>() {
            @Override
